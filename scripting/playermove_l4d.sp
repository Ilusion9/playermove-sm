...
{
    name = "Player Move - L4D",
    author = "Ilusion9",
    description = "Provides methods of moving players to a different team in L4D.",
    version = "1.0",
...
public APLRes AskPluginLoad2(Handle myself, bool late, char[] error, int err_max)
{
	...
	{
		strcopy(error, err_max, "Expected L4D Engine");
...
{
	LoadTranslations("playermove_l4d.phrases");
